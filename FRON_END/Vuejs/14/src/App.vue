<template>
  <div class="container">
    <form action="">
      <div class="row">
        ...
        >
          ...
          <div class="form-group">
            ...
            <!-- The following code showing us, what 'v-model' does  behind the scene. -->
      ...
      <div class="row">
        <div
          class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-affset-3 form-group"
        >
      ...
      <div class="row">
        ...
        >
          ...
          <label for="female">
            <input type="radio" id="femail" value="Female" v-model="gender" />
            Female
          </label>
        </div>
      </div>
      <div class="row">
        ...
        >
          ...
          <select id="priority" class="form-control" v-model="selectedPriority">
            ...
            <!-- :selected="priority == 'Medium' => just work if we don't use v-model" -->
          </select>
        </div>
      </div>
      <div class="row">

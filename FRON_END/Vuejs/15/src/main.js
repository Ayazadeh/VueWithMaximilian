...
Vue.directive("highlight", {
  // Directive have a 5 hook method => 1) bind(el, binding, vnode),
  //  2) inserted(el, binding, vnode), 3) update(el, binding, vnode, oldVnode),
  //  4) componentUpdated(el, binding, vnode, oldVnode), unbind(el, binding, vnode))
